...
export default function MoMReviewPage({
  ...
  /*
   * IMPORTANT:
   * This ref points to the actual MoM document,
   * not the top control buttons.
   */
  ...
  const generateMomPdf = async (): Promise<Blob> => {
    const element = momPdfRef.current;
    ...
    /*
     * Wait for all images inside the MoM document.
    ...
    try {
      ...
      /*
       * Get the real rendered document dimensions.
       */
      const documentWidth = element.scrollWidth;
      const documentHeight = element.scrollHeight;

      /*
       * Calculate the document height inside the PDF
      ...
      /*
       * If the MoM fits on one A4 page,
       * add it as a single image.
       */
      if (pdfImageHeight <= pageHeight) {
         ...
         * Multi-page handling.
         *
         * The same rendered MoM image is placed across
         * multiple A4 pages.
         */
        ...
        while (remainingHeight > 0) {
          position = remainingHeight - pdfImageHeight;
        ...
        <div className="px-8 md:px-14 pb-10 md:pb-14">
          ...
          {riskProfile && (
            <div className="mb-6">
              ...
              <p className="text-sm text-gray-800 leading-relaxed">
                ...
                The advice is based on the client&apos;s assessed requirements,
                goals, investment horizon, financial position, as understood and
                recorded at the time of analysis. Based on this assessment, the
                proposed solution is considered suitable and aligned with the
                client&apos;s requirements and risk profile.
              </p>
            </div>
          )}
          ...
          <div className="bg-gray-100 rounded-2xl border-l-[6px] border-ekvity-green px-6 md:px-8 py-6 text-[11px] leading-[1.7] text-gray-700">
            ...
            <p className="mt-2">
              ...
              certification from National Institute of Securities Markets (NISM)
          ...
          {/* PAGE FOOTER STRIP */}
          <div className="mt-8 pt-4 border-t border-gray-200 text-[10px] text-gray-500 leading-[1.6]">
